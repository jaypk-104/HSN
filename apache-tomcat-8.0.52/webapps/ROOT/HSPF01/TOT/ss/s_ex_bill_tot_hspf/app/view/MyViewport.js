...
Ext.define('S_EX_BILL_TOT_HSPF.view.MyViewport', {
    extend: 'Ext.container.Viewport',
    alias: 'widget.myviewport',

    requires: [
        'S_EX_BILL_TOT_HSPF.view.MyViewportViewModel',
        'S_EX_BILL_TOT_HSPF.view.MyViewportViewController',
        'S_EX_BILL_TOT_HSPF.view.TbButton',
        'S_EX_BILL_TOT_HSPF.view.MyForm',
        'S_EX_BILL_TOT_HSPF.view.MyGrid',
        'S_EX_BILL_TOT_HSPF.view.MyGrid1',
        'Ext.form.Panel',
        'Ext.grid.Panel',
                                            ...
                                            listeners: {
                                                afterrender: function(c) {
                                                	c.getEl().on('dblclick', function() {
                                                		var popup = Ext.create("S_EX_BILL_TOT_HSPF.view.MyWindow1");
...
//                                                        popStore.removeAll();      
                                                        S_EX_BILL_TOT_HSPF.app.getController("PopController").w_selBtn1Click();
                                                    });
                                                }
                                            },
                                        },
