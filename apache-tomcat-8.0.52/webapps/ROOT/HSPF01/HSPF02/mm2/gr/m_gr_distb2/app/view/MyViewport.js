...
Ext.define('M_GR_DISTB2.view.MyViewport', {
    extend: 'Ext.container.Viewport',
    alias: 'widget.myviewport',

    requires: [
        'M_GR_DISTB2.view.MyViewportViewModel',
        'M_GR_DISTB2.view.MyViewportViewController',
        'Ext.button.Button',
        'Ext.form.Panel',
        'Ext.form.FieldSet',
                                                    ...
                                                    listeners: {
                                                        afterrender: function(c) {
                                                        	c.getEl().on('dblclick', function() {
                                                    			...
                                                    			Ext.getCmp('fieldType').setValue('M_GR_DISTB22');
                        ...
                        },
                        {
                            ...
                            columns: [
                                ...
                                },
                                {
                                    ...
                                    align: 'end',
                                    dataIndex: 'BOX_QTY',
                                    text: '<span style=\'color:red\'>*</span>BOX수량',
                                    format: '0,000',
                                    editor: {
                                    	xtype: 'numberfield'
                                    },
                                ...
                                },
                                {
                                	...
                                	width: 150,
                                	dataIndex: 'BL_DOC_NO',
                                	text: '<span style=\'color:red\'>*</span>B/L번호',
                                	editor: {
                                		xtype: 'textfield'
                                	}
                                },
