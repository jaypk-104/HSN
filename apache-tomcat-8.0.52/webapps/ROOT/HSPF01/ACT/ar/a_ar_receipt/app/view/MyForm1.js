...
Ext.define('A_AR_RECEIPT.view.MyForm1', {
    extend: 'Ext.form.Panel',
    alias: 'widget.myform1',

    requires: [
        'A_AR_RECEIPT.view.MyFormViewModel1',
        'A_AR_RECEIPT.view.MyFormViewController1',
        'Ext.form.FieldSet',
                            ...
                            listeners: {
                                afterrender: function(c) {
                                	c.getEl().on('dblclick', function() {
                                		var popup = Ext.create("A_AR_RECEIPT.view.MyWindow1");
