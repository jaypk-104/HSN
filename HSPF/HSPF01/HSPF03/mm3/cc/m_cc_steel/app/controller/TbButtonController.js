...
Ext.define('M_CC_STEEL.controller.TbButtonController', {
    	...
    	if((Ext.getCmp('V_CC_NO').getValue() != '')) {
        	Ext.Ajax.request({
    			...
    			success: function(response) {
        			...
        			Ext.getCmp('V_XCH_RATE').setValue(res.XCH_RATE);
        			Ext.getCmp('V_CY_DT').setValue(res.CY_DT);
        			Ext.getCmp('V_SPOT_XCH').setValue(res.SPOT_XCH);
    		    	
        			store1.load({
    		    		params: {
    		    			V_TYPE: 'S',//CC조회 - 통관정보 하단 ? 
    		    			V_COMP_ID : parent.Ext.getCmp('GCOMP_ID').getValue(),
    						V_USR_ID : parent.Ext.getCmp('GUSER_ID').getValue(),
    	    				V_CC_NO : Ext.getCmp('V_CC_NO').getValue(),
    		    		},
