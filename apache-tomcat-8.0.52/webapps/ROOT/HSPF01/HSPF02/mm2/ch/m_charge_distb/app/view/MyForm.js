...
Ext.define('M_CHARGE_DISTB.view.MyForm', {
    extend: 'Ext.form.Panel',
    alias: 'widget.myform',

    requires: [
        'M_CHARGE_DISTB.view.MySearchFormViewModel',
        'Ext.form.FieldSet',
                                ...
                                afterrender: function(c) {
                                	c.getEl().on('dblclick', function() {
                                		...
                                		if(Ext.getCmp('V_PR_STEP').getValue() == 'VC') {
                                			var popup = Ext.create("M_CHARGE_DISTB.view.WinCcPop");
...
//                                			popStore.removeAll();
                                			...
                                			M_CHARGE_DISTB.app.getController("MyPopController").popSelBtnClick();
                                			
                                		} else if (Ext.getCmp('V_PR_STEP').getValue() == 'VB') {
                                			var popup = Ext.create("M_CHARGE_DISTB.view.WinBlPop");
                                			popup.setSize(width, height);
                                			popup.center();
                                			popup.show();
...
//                                			popStore.removeAll();
                                			...
                                			var popup = Ext.create("M_CHARGE_DISTB.view.WinLcPop");
                                			popup.setSize(width, height);
                                			popup.center();
                                			popup.show();
