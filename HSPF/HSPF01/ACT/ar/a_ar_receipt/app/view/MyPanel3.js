...
Ext.define('A_AR_RECEIPT.view.MyPanel3', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.mypanel3',

    requires: [
        'A_AR_RECEIPT.view.MyPanelViewModel3',
        'Ext.grid.Panel',
        'Ext.form.FieldSet', 
...
//	        							var popup = Ext.create("A_AR_RECEIPT.view.MyWindow2");
//	        							popup.center();
//	        		                    popup.show();
//        							});
//        						}
                    ...
                    plugins: [
                        {
                    	    ...
                    	    listeners : {
                    	    	afteredit: function(e) {
                					...
                					var originalVal = e.context.originalValue;
                			    	...
                			    	if(field == 'ACCT_CD' && val != originalVal) {
                			    		var store3 = Ext.getStore('MyStore3');
                			    		var arrStore = Ext.getStore('ArrayStore');
                			    		store3.removeAll();
                			    		arrStore.data.items[record.get('SEQ')] = null;
