...
Ext.define('M_CHARGE_TOT_HSPF.controller.MyGridController', {
    ...
    gridAddBtnClick: function(button, e, eOpts) {
    	...
    	if(Ext.getCmp('V_BAS_NO').getValue() != '') {
	        var popup = Ext.create("M_CHARGE_TOT_HSPF.view.WinAddRow");
	        popup.show();
...
//    	}
    	...
    	for(var i in gridRecord){
    		selectedAmt += gridRecord[i].get('LOC_AMT');
    	}
    	Ext.getCmp('V_SELECTED_AMT').setValue(Ext.util.Format.number(selectedAmt, '0,000'));
					...
					if (button == 'yes') {
						...
						store.sync({ 
							params : {
								...
								V_MAST_CHARGE_NO : gridRecord[0].get('MAST_CHARGE_NO'),//Ext.getCmp('V_MAST_CHARGE_NO').getValue(),
								V_PR_STEP : Ext.getCmp('V_PR_STEP').getValue(),
							},
