Ext.define('M_BL_TOT_HSPF.view.MyWindow', {
    extend: 'Ext.window.Window',
    alias: 'widget.mywindow',

    requires: [
        'M_BL_TOT_HSPF.view.MyWindowViewModel',
    ...
    items: [
        {
            ...
            items: [{
                ...
                anchor: '40%',
                buttonText: '파일첨부',
                emptyText: '첨부파일을 끌어다 놓거나 파일첨부 버튼을 클릭해주세요',
                listeners:{
                    ...
                    change : function(object, value, eOpts ){
                    	...
                    	var form = this.up('form').getForm();
                    	 if(form.isValid()){
                    		 ...
                    		 form.submit({
                                 url: 'sql/M_BL_TOT_HSPF_FILE.jsp?'+params,
                ...
                drop: function(e) {
                    ...
                    for (var i = 0; i < store.data.items.length; i++) {
                    	if (!(store.getData().getAt(i).data.status === "Uploaded")) {
                            ...
                            xhr.open("POST", 'sql/M_BL_TOT_HSPF_FILE.jsp?' + params, false);
                            fd.append('index', i);
