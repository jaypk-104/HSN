...
Ext.define('M_CHARGE_STEEL.controller.MyPopController', {
	...
	popRegBtnClick: function(button, e, eOpts) {
		...
		if(gridRecord[0].get('CHARGE_YN') == 'N') {
			if(V_PR_STEP == 'VL') {
	    		var rec1 = Ext.create('M_CHARGE_STEEL.model.MyModel', {
...
//	    			BANK_ACCT: '168-01-000130-9',
	    		...
	    		var rec2 = Ext.create('M_CHARGE_STEEL.model.MyModel', {
	    			BAS_NO: gridRecord[0].get('LC_NO'),
	    			LC_DOC_NO: gridRecord[0].get('LC_DOC_NO'),
...
//	    			BANK_ACCT: '168-01-000130-9',
	    		...
	    		var rec3 = Ext.create('M_CHARGE_STEEL.model.MyModel', {
	    			BAS_NO: gridRecord[0].get('LC_NO'),
	    			LC_DOC_NO: gridRecord[0].get('LC_DOC_NO'),
	    			CHARGE_CD: 'SPC12', //보험료
	    			CHARGE_DT: new Date(),
...
//	    			BANK_ACCT: '168-01-000130-9',
				...
				var rec14 = Ext.create('M_CHARGE_STEEL.model.MyModel', {
...
//	    			BANK_ACCT: '168-01-000130-9',
				...
				var rec15 = Ext.create('M_CHARGE_STEEL.model.MyModel', {
	    			BAS_NO: gridRecord[0].get('BL_NO'),
	    			BL_DOC_NO: gridRecord[0].get('BL_DOC_NO'),
	    			CHARGE_CD: 'SPC92', //커미션
	    			CHARGE_DT: new Date(),
...
//	    			BANK_ACCT: '168-01-000130-9',
	    		...
	    		var rec4 = Ext.create('M_CHARGE_STEEL.model.MyModel', {
	    			BAS_NO: gridRecord[0].get('BL_NO'),
	    			BL_DOC_NO: gridRecord[0].get('BL_DOC_NO'),
//	    			LC_DOC_NO: record.get('LC_DOC_NO'),
...
//	    			BANK_ACCT: '168-01-000130-9',
	    		...
	    		var rec5 = Ext.create('M_CHARGE_STEEL.model.MyModel', {
	    			BAS_NO: gridRecord[0].get('BL_NO'),
	    			BL_DOC_NO: gridRecord[0].get('BL_DOC_NO'),
//	    			LC_DOC_NO: record.get('LC_DOC_NO'),
...
//	    			BANK_ACCT: '168-01-000130-9',
	    		...
	    		var rec6 = Ext.create('M_CHARGE_STEEL.model.MyModel', {
	    			BAS_NO: gridRecord[0].get('BL_NO'),
	    			BL_DOC_NO: gridRecord[0].get('BL_DOC_NO'),
...
//	    			BANK_ACCT: '168-01-000130-9',
	    		...
	    		var rec7 = Ext.create('M_CHARGE_STEEL.model.MyModel', {
	    			BAS_NO: gridRecord[0].get('BL_NO'),
	    			BL_DOC_NO: gridRecord[0].get('BL_DOC_NO'),
//	    			LC_DOC_NO: record.get('LC_DOC_NO'),
...
//	    			BANK_ACCT: '168-01-000130-9',
	    		...
	    		var rec8 = Ext.create('M_CHARGE_STEEL.model.MyModel', {
	    			BAS_NO: gridRecord[0].get('BL_NO'),
	    			BL_DOC_NO: gridRecord[0].get('BL_DOC_NO'),
//	    			LC_DOC_NO: record.get('LC_DOC_NO'),
	    			CHARGE_CD: 'SPC36', //DEM
	    		...
	    		var rec9 = Ext.create('M_CHARGE_STEEL.model.MyModel', {
	    			BAS_NO: gridRecord[0].get('BL_NO'),
	    			BL_DOC_NO: gridRecord[0].get('BL_DOC_NO'),
//	    			LC_DOC_NO: record.get('LC_DOC_NO'),
	    			CHARGE_CD: 'SPCA1', //전기료
	    		...
	    		var rec10 = Ext.create('M_CHARGE_STEEL.model.MyModel', {
	    			BAS_NO: gridRecord[0].get('BL_NO'),
	    			BL_DOC_NO: gridRecord[0].get('BL_DOC_NO'),
//	    			LC_DOC_NO: record.get('LC_DOC_NO'),
...
//	    			BANK_ACCT: '168-01-000130-9',
	    		...
	    		var rec11 = Ext.create('M_CHARGE_STEEL.model.MyModel', {
	    			BAS_NO: gridRecord[0].get('BL_NO'),
	    			BL_DOC_NO: gridRecord[0].get('BL_DOC_NO'),
//	    			LC_DOC_NO: record.get('LC_DOC_NO'),
...
//	    			BANK_ACCT: '168-01-000130-9',
	    		...
	    		var rec12 = Ext.create('M_CHARGE_STEEL.model.MyModel', {
	    			BAS_NO: gridRecord[0].get('BL_NO'),
	    			BL_DOC_NO: gridRecord[0].get('BL_DOC_NO'),
//	    			LC_DOC_NO: record.get('LC_DOC_NO'),
	    			CHARGE_CD: 'SPCA2', //운송료
...
//	    			BANK_ACCT: '168-01-000130-9',
	    		...
	    		var rec13 = Ext.create('M_CHARGE_STEEL.model.MyModel', {
	    			BAS_NO: gridRecord[0].get('BL_NO'),
	    			BL_DOC_NO: gridRecord[0].get('BL_DOC_NO'),
//	    			LC_DOC_NO: record.get('LC_DOC_NO'),
	    			CHARGE_CD: 'SPC28', //THC
...
//		console.log(Ext.getCmp('V_TEMP_GL_NO').getValue());
	...
	popGridDblClick : function(tableview, td, cellIndex, record, tr, rowIndex, e, eOpts) {
		...
		console.log(V_PR_STEP);
		console.log(record.get('CHARGE_YN'));
...
//	    			BANK_ACCT: '168-01-000130-9',
				...
				var rec5 = Ext.create('M_CHARGE_STEEL.model.MyModel', {
					...
					BL_DOC_NO: record.get('BL_DOC_NO'),
					LC_DOC_NO: record.get('LC_DOC_NO'),
					CHARGE_CD: 'SPC88', //DELIVERY ORDER FEE
					CHARGE_DT: new Date(),
					CUR: 'KRW',
					TAX_BIZ_CD: 'TX3',
					XCHG_RT: '1',
