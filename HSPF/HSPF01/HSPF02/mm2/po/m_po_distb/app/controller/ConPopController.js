...
Ext.define('M_PO_DISTB.controller.ConPopController', {
	...
	w_conSelBtnClick: function() {
		...
		popStore.load({
    		params: {
    			...
    			V_APPROV_DT_FR : Ext.getCmp('V_APPROV_DT_FR').getValue(),//품의일자
    			V_APPROV_DT_TO : Ext.getCmp('V_APPROV_DT_TO').getValue(),//품의일자
    		},
			...
			success: function(response) {
				...
				for(var i=0; i<res.length; i++) {
					if(res[i].M_BP_CD == Ext.getCmp('V_M_BP_CD').getValue()) {
						var rec = Ext.create('M_PO_DISTB.model.MyModel', {
