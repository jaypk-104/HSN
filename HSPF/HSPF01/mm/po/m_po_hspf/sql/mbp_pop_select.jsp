...
<%
	...
	try {
		...
		String W_ITEM_CD2 = request.getParameter("W_ITEM_CD2") == null ? "" : request.getParameter("W_ITEM_CD2").toUpperCase();
		String W_ITEM_NM2 = request.getParameter("W_ITEM_NM2") == null ? "" : request.getParameter("W_ITEM_NM2").toUpperCase();

// 		System.out.println("V_TYPE" + V_TYPE);
// 		System.out.println("V_BP_CD" + V_BP_CD);
// 		System.out.println("V_BP_NM" + V_BP_NM);
// 		System.out.println("W_ITEM_CD2" + W_ITEM_CD2);
		...
		cs.setString(5, W_ITEM_CD2);//V_ITEM_CD
		cs.setString(6, W_ITEM_NM2);//V_ITEM_NM
