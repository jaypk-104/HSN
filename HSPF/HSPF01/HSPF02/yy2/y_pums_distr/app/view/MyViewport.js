...
Ext.define('Y_PUMS_DISTR.view.MyViewport', {
    extend: 'Ext.container.Viewport',
    alias: 'widget.myviewport',

    requires: [
        'Y_PUMS_DISTR.view.MyViewportViewModel',
        'Y_PUMS_DISTR.view.MyViewportViewController',
        'Y_PUMS_DISTR.view.TbButton',
        'Y_PUMS_DISTR.view.MyForm',
        'Ext.form.Panel',
        'Ext.form.Label',
                                                    ...
                                                    listeners: {
                                                    	click:  function(button, e, eOpts) {
                                                    		if(Ext.getCmp('V_RISK_NO').getValue() != '') {
                                                            		var popup = Ext.create("Y_PUMS_DISTR.view.MyWindow");
                                                                    ...
                                                                    listeners: {
                                                                    	click:  function(button, e, eOpts) {
                                                                    		if(Ext.getCmp('V_RISK_NO').getValue() != '') {
                                                                        		...
                                                                        		var rec = Ext.create('Y_PUMS_DISTR.model.MyModel', {
                                                                        		});
                                                                		...
                                                                		listeners: {
                                                                            'change' : function (field, newValue, oldValue) {
                                                                            	if(newValue != oldValue){
                                                                            		var selectedRecord = this.up().up().actionPosition.record;
                                                                            		if(newValue === 'E'){
                                                                            			selectedRecord.set('TERMS', 90);
                                                                            		} else {
                                                                            			selectedRecord.set('TERMS', '');
                                                                            		}
                                                                            	}
                                                                            }
                                                                        },
