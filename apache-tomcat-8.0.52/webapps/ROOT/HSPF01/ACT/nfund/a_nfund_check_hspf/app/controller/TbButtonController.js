...
Ext.define('A_NFUND_CHECK_HSPF.controller.TbButtonController', {
    extend: 'Ext.app.Controller',

    stores: ['MyStore', 'DeptStore'],
    control: {
        "#selBtn": {
            click: 'selBtnClick'
        },
    ...
    saveBtnClick: function(button, e, eOpts) {
    	...
    	store.sync({
			...
			callback : function(records, operation, success) {
				var tbController = A_NFUND_CHECK_HSPF.app.getController("TbButtonController");
