...
Ext.define('Y_PUMS_STEEL.view.WinRiskPop', {
	extend : 'Ext.window.Window',
	alias : 'widget.winriskpop',

	requires : [ 'Y_PUMS_STEEL.view.WinAddRowViewModel1', 'Ext.form.FieldSet', 'Ext.form.field.Date', 'Ext.grid.Panel', 'Ext.view.Table', 'Ext.grid.column.RowNumberer', 'Ext.grid.column.Date', 'Ext.grid.column.Number', 'Ext.form.field.Number', 'Ext.selection.CheckboxModel', 'Ext.grid.plugin.Exporter', 'Ext.button.Button' ],
