...
Ext.define('S_TAX_STEEL.controller.MyGridController1', {
	...
	taxBillBtnClick : function(button, e, eOpts) {
		var BILL_NO = Ext.getCmp('V_TAX_BILL_NO').getValue();
		
		if(!!!BILL_NO){
			Ext.Msg.alert('확인', '계산서관리번호가 없습니다.');
		} else {
			var popup = Ext.create("Popup.view.WinBillPop");
			Ext.getCmp('V_SHOW_TYPE').setValue('S_TAX_STEEL');
