...
Ext.define('M_BL_STEEL.view.MySearchForm', {
    extend: 'Ext.form.Panel',
    alias: 'widget.mysearchform',

    requires: [
        'M_BL_STEEL.view.MySearchFormViewModel',
        'Ext.form.FieldSet',
                            ...
                            listeners: {
                                afterrender: function(c) {
                                	c.getEl().on('dblclick', function() {
                                		var popup = Ext.create("M_BL_STEEL.view.WinBlPop");
                            ...
                            listeners: {
                                afterrender: function(c) {
                                	c.getEl().on('dblclick', function() {
                            			...
                            			Ext.getCmp('fieldType').setValue('M_BL_STEEL2');
                            ...
                            listeners: {
                            	change: function(field, newValue, oldValue, eOpts) {
                            		...
                            		store1.each(function(record, idx) {
                            			...
                            			var PRICE2 = Math.floor(record.get('PRICE')*100)/100;
                        	...
                        	listeners: {
                                afterrender: function(c) {
                                	c.getEl().on('dblclick', function() {
                            			...
                            			var popup = Ext.create("M_BL_STEEL.view.WinLcChargePop");
                            			var store = Ext.getStore('LcChargePopStore');
                            			store.removeAll();
                            			Ext.getCmp('W_LC_DOC_NO').setValue(Ext.getCmp('V_H_LC_DOC_NO').getValue());
                            			popup.show();
