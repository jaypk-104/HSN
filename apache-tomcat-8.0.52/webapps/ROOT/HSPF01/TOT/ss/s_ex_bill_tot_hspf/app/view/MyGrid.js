...
Ext.define('S_EX_BILL_TOT_HSPF.view.MyGrid', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.myGrid',

    requires: [
        'S_EX_BILL_TOT_HSPF.view.MyGridViewModel',
			...
			select : function(rowmodel, record, index, eOpts) {
				...
				if(store1.getCount() > 0 && Ext.getCmp('V_S_BP_CD2').getValue() != record.get('S_BP_CD')) {
					...
					if(record.get('BILL_NO') == null){
						...
						Ext.getCmp('V_XCHG_RT').setValue(record.get('XCHG_RT'));
					} else {
						Ext.Ajax.request({
...
//									Ext.getCmp('V_SALE_TYPE').setValue(resultData.SALE_TYPE);
					...
					var BILL_QTY = record.get('BILL_QTY');
