...
Ext.define('M_IV_STEEL.view.MyViewport', {
    extend: 'Ext.container.Viewport',
    alias: 'widget.myviewport',

    requires: [
        'M_IV_STEEL.view.MyViewportViewModel',
        'M_IV_STEEL.view.MyViewportViewController',
        'M_IV_STEEL.view.TbButton',
        'M_IV_STEEL.view.MyForm',
        'M_IV_STEEL.view.MyGrid',
        'M_IV_STEEL.view.MyGrid1',
        'Ext.form.Panel',
        'Ext.grid.Panel',
                                            ...
                                            listeners: {
                                                afterrender: function(c) {
                                                	c.getEl().on('dblclick', function() {
                                                		var popup = Ext.create("M_IV_STEEL.view.MyWindow1");
                                            ...
                                            listeners: {
                                                afterrender: function(c) {
                                                	c.getEl().on('dblclick', function() {
                                            			...
                                            			Ext.getCmp('fieldType').setValue('M_IV_STEEL2');
                                            ...
                                            listeners: {
                                                afterrender: function(c) {
                                                	c.getEl().on('dblclick', function() {
                                            			...
                                            			Ext.getCmp('fieldType').setValue('M_IV_STEEL');
