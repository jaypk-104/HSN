...
<%
	...
	try {
		String V_TYPE = "ITEMGRP";
		String V_ITEM_CD = request.getParameter("W_ITEMGRP_CD") == null ? "" : request.getParameter("W_ITEMGRP_CD").toUpperCase();
		String V_ITEM_NM = request.getParameter("W_ITEMGRP_NM") == null ? "" : request.getParameter("W_ITEMGRP_NM").toUpperCase();
