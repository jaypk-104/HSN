...
Ext.define('S_PROFIT_TOT_HSPF.controller.MyGridController', {
			...
			if (button == 'yes') {
				Ext.Ajax.request({
					...
					success : function(response) {
						...
						var tbController = S_PROFIT_TOT_HSPF.app.getController("TbButtonController");
