...
Ext.define('SCM_DLVY_HSPF.view.AsnPop', {
    extend: 'Ext.window.Window',
    alias: 'widget.asnpop',

    requires: [
        'SCM_DLVY_HSPF.view.AsnPopViewModel',
        'SCM_DLVY_HSPF.view.AsnPopViewController',
        'SCM_DLVY_HSPF.view.MySearchForm1',
        'Ext.form.Panel',
        'Ext.grid.Panel',
        'Ext.view.Table',
                                ...
                                click: {
                                    ...
                                    fn: function (id) {
                                    	...
                                    	if(flag == 'T') { //확정취소 상태일 때만..
                                			if(chkValue == true) { //첫줄따라등록..
                                        		for(var i=0; i<gridRecord3.length; i++) {
                                        			if(i==0) {
                                        				LOT_NO = gridRecord3[0].data['LOT_NO'];
                                        				MAKE_DT = gridRecord3[0].data['MAKE_DT'];
                                        				VALID_DT = gridRecord3[0].data['VALID_DT'];
                                        			}
