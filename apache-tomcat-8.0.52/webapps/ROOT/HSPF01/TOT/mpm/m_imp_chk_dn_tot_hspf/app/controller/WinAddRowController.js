...
Ext.define('M_IMP_CHK_DN_TOT_HSPF.controller.WinAddRowController', {
	...
	addRowBtnClick : function(button, e, eOpts) {
		...
		for (var i = 0; i < rowCount; i++) {
			count = count + 1;
			var rec = Ext.create('M_IMP_CHK_DN_TOT_HSPF.model.MyModel', {
				V_TYPE : 'I',
				YYYYMMDD : Ext.getCmp('V_YYYYMMDD').lastValue
			});
