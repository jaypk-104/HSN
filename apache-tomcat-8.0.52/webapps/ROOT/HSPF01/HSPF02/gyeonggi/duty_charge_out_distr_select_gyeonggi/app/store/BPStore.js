...
Ext.define('M_DUTY_CHARGE_OUT_DISTR_GYEONGGI.store.BPStore', {
    extend: 'Ext.data.Store',

    requires: [
        'M_DUTY_CHARGE_OUT_DISTR_GYEONGGI.model.taxModel',
        'Ext.data.proxy.Ajax',
    ...
    constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            storeId: 'BPStore',
            autoLoad: true,
            model: 'M_DUTY_CHARGE_OUT_DISTR_GYEONGGI.model.taxModel',
            proxy: {
                type: 'ajax',
                api: {
