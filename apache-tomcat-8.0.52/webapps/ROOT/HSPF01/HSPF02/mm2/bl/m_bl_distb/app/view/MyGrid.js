...
Ext.define('M_BL_DISTB.view.MyGrid', {
	extend : 'Ext.grid.Panel',
	alias : 'widget.myGrid',

	requires : [ 'M_BL_DISTB.view.MyGridViewModel', 'Ext.view.Table', 'Ext.grid.column.RowNumberer', 'Ext.grid.column.Number', 'Ext.form.field.Number', 'Ext.grid.column.Date', 'Ext.selection.CheckboxModel', 'Ext.grid.plugin.Exporter', 'Ext.grid.plugin.CellEditing' ],
...
//						console.log('1: ' + V_EXPECT_LOC_AMT);
...
//						console.log('2: ' + V_EXPECT_LOC_AMT);
//						console.log('3: ' + XCH_RATE);
						...
						if(flag != 'STOP') {
							store1.insert(store1Cnt, [ ({
    							...
    							APPROV_MGM_NO : record.get('APPROV_MGM_NO'),
    							COL_NO : record.get('COL_NO'),
    							COL_TYPE_NM : record.get('COL_TYPE_NM'),
    							COL_TITLE : record.get('COL_TITLE'),
...
//				console.log('3: ' + XCH_RATE);
				...
				store1.each(function(rec, idx) {
            		if(((rec.get('PO_NO') == record.get('PO_NO')) && ((rec.get('PO_SEQ') == record.get('PO_SEQ')) && ((rec.get('CONT_MGM_NO') == record.get('CONT_MGM_NO'))
            				&&  ((record.get('BL_REMAIN_QTY') == rec.get('PO_QTY'))))))) {
						store1.remove(rec);
