...
Ext.define('M_PO_STEEL.view.WinPoPop', {
	extend : 'Ext.window.Window',
	alias : 'widget.winpopop',

	requires : [ 'M_PO_STEEL.view.WinAddRowViewModel1', 'Ext.form.FieldSet', 'Ext.form.field.Date', 'Ext.grid.Panel', 'Ext.view.Table', 'Ext.grid.column.RowNumberer', 'Ext.grid.column.Date', 'Ext.grid.column.Number', 'Ext.form.field.Number', 'Ext.selection.CheckboxModel', 'Ext.grid.plugin.Exporter', 'Ext.button.Button' ],
                ...
                listeners: {
                    afterrender: function(c) {
                    	c.getEl().on('dblclick', function() {
                			...
                			Ext.getCmp('fieldType').setValue('M_PO_STEEL_W');
