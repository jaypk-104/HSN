...
Ext.define('S_EX_BILL_DISTR.view.MyViewport', {
    extend: 'Ext.container.Viewport',
    alias: 'widget.myviewport',

    requires: [
        'S_EX_BILL_DISTR.view.MyViewportViewModel',
        'S_EX_BILL_DISTR.view.MyViewportViewController',
        'S_EX_BILL_DISTR.view.TbButton',
        'S_EX_BILL_DISTR.view.MyForm',
        'S_EX_BILL_DISTR.view.MyGrid',
        'S_EX_BILL_DISTR.view.MyGrid1',
        'Ext.form.Panel',
        'Ext.grid.Panel',
                                            ...
                                            listeners: {
                                                afterrender: function(c) {
                                                	c.getEl().on('dblclick', function() {
                                                		var popup = Ext.create("S_EX_BILL_DISTR.view.MyWindow1");
...
//                                                        popStore.removeAll();      
                                                        S_EX_BILL_DISTR.app.getController("PopController").w_selBtn1Click();
                                                    });
                                                }
                                            },
                                        },
