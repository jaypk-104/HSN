...
Ext.define('DUTY_CHARGE_OUT_DISTR_SELECT.view.MyGrid', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.myGrid',

    requires: [
        'DUTY_CHARGE_OUT_DISTR_SELECT.view.MyGridViewModel',
        'DUTY_CHARGE_OUT_DISTR_SELECT.view.MyGridViewController',
        'Ext.view.Table',
    ...
    viewConfig: {
        getRowClass: function(record, rowIndex, rowParams, store) {
            var ESEND_YN = record.get('ERP_YN');
