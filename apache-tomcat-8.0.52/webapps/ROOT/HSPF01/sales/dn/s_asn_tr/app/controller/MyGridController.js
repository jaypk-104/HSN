...
Ext.define('S_ASN_TR.controller.MyGridController', {
    ...
    ifSendBtnClick: function(button, e, eOpts) {
    	Ext.Msg.confirm('확인','미전송 내역들을 전송하시겠습니까?', function(button){
			if(button == 'yes') {
				Ext.Ajax.request({
					url:'sql/s_asn_tr.jsp',
					method: 'post',
					params: {
						V_TYPE: 'IF', //인터페이스 
