...
Ext.define('R_SIS_CHEM_F2.controller.TbButtonController', {
    ...
    selBtnClick: function(button, e, eOpts) {
        var store_arr = ['F01','F02','F03','F04','F05','F06'];
        var class_arr = ['NUM','NUM','NUM','NUM','CHAR','CHAR'];
        ...
        for(var i = 0 ; i < chart_arr.length ; i ++){
            var store = this.getStore(store_arr[i] + '_Chart_Store');
            store.load({
                params: {
                    V_TYPE: chart_arr[i],
                    V_CLASS : 'CHART',
