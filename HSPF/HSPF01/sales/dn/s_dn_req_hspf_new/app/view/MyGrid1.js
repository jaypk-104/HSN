...
Ext.define('S_DN_REQ_HSPF_NEW.view.MyGrid1', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.mygrid1',

    requires: [
        'S_DN_REQ_HSPF_NEW.view.MyGrid1ViewModel',
        'S_DN_REQ_HSPF_NEW.view.MyGrid1ViewController',
        'Ext.view.Table',
...
//        	hidden: true
    ...
    viewConfig: {
      	...
      	getRowClass: function(record, index) {
            ...
            var EXCEED_YN = record.get('EXCEED_YN'); //발주수량초과여부
