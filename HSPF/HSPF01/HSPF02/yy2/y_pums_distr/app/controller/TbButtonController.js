...
Ext.define('Y_PUMS_DISTR.controller.TbButtonController', {
...
//						console.log(res.RISK_TYPE);
    ...
    saveBtnClick: function(button, e, eOpts) {
    	...
    	if(flag == 'T') {
    		Ext.Ajax.request({
        		...
        		callback : function(records,operations,success){
        			// [20200227 HDH] 저장버튼 하나로 그리드 변경건 같이 처리하도록 수정 
        			var MyGridController = this.getController('MyGridController');
        			MyGridController.gridSaveBtn1Click(null, null, null);
        			MyGridController.gridSaveBtn2Click(null, null, null);
        			MyGridController.gridSaveBtn3Click(null, null, null);
    			},
        	    success : function(response) {
        	    	var res = response.responseText;
        	    	if(res.match('Exception')) {
    ...
    clrBtnClick: function(button, e, eOpts) {
		...
		Ext.getCmp('V_DEPT_CD').setValue('5124');
