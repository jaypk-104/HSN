...
Ext.define('I_STOCK_ERP_PF_TOTAL.controller.MyGridController', {
    ...
    exeBtnClick: function(button, e, eOpts) {
    	Ext.Msg.confirm('확인','재고실행하시겠습니까?', function(button){
			if(button == 'yes') {
				var myMask = new Ext.LoadMask(Ext.getCmp('myGrid') , {msg:"Please wait..."});
		    	myMask.show();
				Ext.Ajax.request({
		    		url:'sql/i_stock_erp_pf_total.jsp',
		    		method: 'post',
		    		params: {
		    			V_TYPE : 'EXECUTE',
