...
Ext.define('ST_ITEM_STEEL.view.MyForm', {
    extend: 'Ext.form.Panel',
    alias: 'widget.myform',

    requires: [
        'ST_ITEM_STEEL.view.MyFormViewModel',
        'ST_ITEM_STEEL.view.MyFormViewController',
        'Ext.form.FieldSet',
                            ...
                            listeners: {
                                afterrender: function(c) {
                                	c.getEl().on('dblclick', function() {
                            			...
                            			Ext.getCmp('fieldType').setValue('ST_ITEM_STEEL');
