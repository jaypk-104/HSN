...
Ext.define('SCM_DLVY_HSPF.controller.MyGridController1', {
	...
	/* MyStore2 : [ USP_SCM_DLVY_HSPF_D ] */
	/* MyStore3 : [ USP_SCM_DLVY_HSPF_D ] */
	...
	gridASNBtn : function(button, e, eOpts) {
		...
		if (gridRecord1.length == 0) {
			...
			var popup = Ext.create("SCM_DLVY_HSPF.view.AsnPop");
			popup.show();
