...
Ext.define('M_CHARGE_OUT_DISTR2.view.MyGrid', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.myGrid',

    requires: [
        'M_CHARGE_OUT_DISTR2.view.MyGridViewModel',
        'M_CHARGE_OUT_DISTR2.view.MyGridViewController',
        'Ext.view.Table',
    ...
    onNumberfieldChange: function(field, newValue, oldValue, eOpts) {
        ...
        */
        ...
        if(record.data['VAT_CD'] == 'V01' || record.data['VAT_CD'] == 'V04'){ // 일반세금계산서. 종이세금계산서.
            var vat_amt = Math.round(Number(newValue) / 10);
            var vat_amt_old = Math.round(Number(oldValue) / 10);
        ...
        else if(record.data['VAT_CD'] == 'V05'){ // 경비.
            record.set('VAT_AMT',0);
