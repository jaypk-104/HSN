...
Ext.define('S_BILL_STEEL.controller.MyGridController', {
	...
	cfmBtnClick: function(button, e, eOpts) {
    	...
    	if(flag == 'T') {
    	Ext.Msg.confirm('확인', '매출채권등록 하시겠습니까?', function(button) {
			if (button == 'yes') {
			    		if(Ext.getCmp('V_BILL_NO').getValue() == '') {
			    			Ext.Ajax.request({
			        			url : 'sql/S_BILL_STEEL.jsp',
			        			method : 'post',
			        			params: {
			        				V_TYPE: 'IH',
			        				...
			        				if(!res.match('Exception')) {
			        					...
			        					store1.sync({ 
			        						...
			        						callback : function(records, operation, success) {
			        				    		var tbController = S_BILL_STEEL.app.getController("TbButtonController");
