...
Ext.define('S_RETURN_HSPF.controller.WinAddRowController', {
    ...
    onGridpanelCellDblClick: function(tableview, td, cellIndex, record, tr, rowIndex, e, eOpts) {
        ...
        var nows = new Date();
        var rec = Ext.create('S_RETURN_HSPF.model.MyModel', {
        	CFM_YN : 'N',
        	RE_GR_YN : 'N',
        	RE_DT : nows,
        	S_BP_CD : record.data['BP_CD'],
        	S_BP_NM : record.data['BP_NM'],
