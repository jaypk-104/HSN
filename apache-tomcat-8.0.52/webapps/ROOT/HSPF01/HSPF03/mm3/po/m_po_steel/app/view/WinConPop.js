...
Ext.define('M_PO_STEEL.view.WinConPop', {
    extend: 'Ext.window.Window',
    alias: 'widget.winconpop',

    requires: [
        'M_PO_STEEL.view.WinAddRowViewModel2',
        'Ext.form.FieldSet',
        'Ext.form.field.Date',
        'Ext.grid.Panel',
        'Ext.view.Table',
                            ...
                            listeners: {
                                afterrender: function(c) {
                                	c.getEl().on('dblclick', function() {
                            			...
                            			Ext.getCmp('fieldType').setValue('M_PO_STEEL_W3');
                            ...
                            listeners: {
                                afterrender: function(c) {
                                	c.getEl().on('dblclick', function() {
                            			...
                            			Ext.getCmp('fieldType').setValue('M_PO_STEEL3');
