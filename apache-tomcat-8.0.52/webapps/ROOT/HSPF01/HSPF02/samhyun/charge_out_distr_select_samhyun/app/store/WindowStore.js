...
Ext.define('CHARGE_OUT_DISTR_SELECT_SAMHYUN.store.WindowStore', {
    extend: 'Ext.data.Store',

    requires: [
        'CHARGE_OUT_DISTR_SELECT_SAMHYUN.model.MyModel',
        'Ext.data.proxy.Ajax',
    ...
    constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            storeId: 'WindowStore',
            model: 'CHARGE_OUT_DISTR_SELECT_SAMHYUN.model.MyModel',
            proxy: {
                type: 'ajax',
                api: {
