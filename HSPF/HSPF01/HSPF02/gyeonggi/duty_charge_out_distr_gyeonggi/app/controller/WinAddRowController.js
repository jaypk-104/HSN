...
Ext.define('M_DUTY_CHARGE_OUT_DISTR_GYEONGGI.controller.WinAddRowController', {
    ...
    W_D_addBtnClick: function(button, e, eOpts) {
        ...
        for(var i=0; i<newGridRecord.length; i++) {
            var rec = Ext.create('M_DUTY_CHARGE_OUT_DISTR_GYEONGGI.model.MyModel', {
...
//            store.insert(0, rec);
    ...
    onTextfieldSp: function(textfield) {
        if (e.getKey() == e.ENTER) {
