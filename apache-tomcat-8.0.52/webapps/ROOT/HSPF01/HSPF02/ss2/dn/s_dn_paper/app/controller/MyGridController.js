...
Ext.define('S_DN_PAPER.controller.MyGridController', {
	...
	sendBtnClick: function() {
    	...
    	if(date.getFullYear() == 2020 && date.getMonth() == 6 && date.getDate() == 29){
    		//오늘날짜로 테스트
//    		Ext.getCmp('m1').setValue(false); //김은민 대리
//    		Ext.getCmp('m2').setValue(false); //한지훈 차장
//    		Ext.getCmp('m8').setValue(false); //테스트관리자
//    		Ext.getCmp('m3').setValue(true); //고용훈 대리
//    		Ext.getCmp('m4').setValue(false); //이용래 부장
    	}
    	else if(date.getFullYear() == 2020 && date.getMonth() == 7 && date.getDate() == 3){
    		//8월 3일
    		Ext.getCmp('m1').setValue(false); //김은민 대리
    		Ext.getCmp('m2').setValue(false); //한지훈 차장
    		Ext.getCmp('m8').setValue(false); //테스트관리자
    	...
    	else if(date.getFullYear() == 2020 && date.getMonth() == 7 && date.getDate() == 4){
    		//8월 4일
    		Ext.getCmp('m1').setValue(true); //김은민 대리
    		Ext.getCmp('m2').setValue(false); //한지훈 차장
    		Ext.getCmp('m8').setValue(false); //테스트관리자
    		Ext.getCmp('m3').setValue(false); //고용훈 대리
    		Ext.getCmp('m4').setValue(false); //이용래 부장
    	}
    		...
    		Ext.Msg.confirm('확인', '요청서를 출력하시겠습니까?', function(button) {
        		if (button == 'yes') {
					...
					var myWin = new Ext.Window({
						title : '출하요청서',
						html : '<iframe name="xxx" border =0 src="http://123.142.124.170:8080/aireport/on_server/S_DN_PAPER_Y.jsp?PRINT_NO='+PRINT_NO+'" width="100%" height="100%"></iframe>',
						width : 1000,
						height : 768,
						modal : true
					});
    ...
    gridDelBtnClick: function(button, e, eOpts) {
		...
		for(var i=0; i<gridRecord.length; i++) {
			console.log(gridRecord[i].get('DN_TYPE'));
	...
	gridDelBtn0Click: function(button, e, eOpts) {
	 ...
	 onLaunch: function(application) {
		 ...
		 if(id =='ADMINGR3'  || id == ''  ||id == 'KHSON'  ||id == 'YRLEE'  ){
			 //Ext.getCmp('CHECK_YN').show();
		 }
	 }
