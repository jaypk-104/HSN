...
Ext.define('M_DUTY_CHARGE_OUT_DISTR_GYEONGGI.controller.MyController', {
    ...
    onLaunch: function(application) {
        Ext.define('M_DUTY_CHARGE_OUT_DISTR_GYEONGGI.override.form.field.Number', {
    ...
    loadTotalAMT: function() {
        ...
        for ( var i = 0 ; i < allRecord.length ; i ++){
            var CHARGE_AMT = Number(allRecord[i].data['CHARGE_AMT']);
            var VAT_AMT = Number(allRecord[i].data['VAT_AMT']);
            if(allRecord[i].data['CHARGE_AMT'] == '' || allRecord[i].data['CHARGE_AMT'] == undefined){
                CHARGE_AMT = 0;
            }
            if(allRecord[i].data['VAT_AMT'] == '' || allRecord[i].data['VAT_AMT'] == undefined){
                VAT_AMT = 0;
            }


            if(allRecord[i].data['VAT_CD'] == 'V01' || allRecord[i].data['VAT_CD'] == 'V04'){ // 일반세금계산서. 종이세금계산서.
                TOTAL_AMT +=  CHARGE_AMT + VAT_AMT;
            }
            else if(allRecord[i].data['VAT_CD'] == 'V05'){ // 경비.
                TOTAL_AMT += CHARGE_AMT;
            }
