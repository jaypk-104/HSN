...
Ext.define('M_SCM_TO_GR_TOT_HSPF.controller.MyGridController1', {
...
//	gridSaveBtnClick : function(button, e, eOpts) {},
	...
	gridGrCancelBtnClick : function(button, e, eOpts) {
		...
		for (var i = 0; i < gridRecord.length; i++) {
			gridRecord[i].set('V_TYPE', 'RI');
		}
		
//		store1.each(function(record, idx) {
//			if(record.get('CHK_YN') === 'Y') {
//				record.set('V_TYPE', 'RI');
//			}
//		})
		
		Ext.Msg.confirm('확인', '입고취소 하시겠습니까?', function(button) {
			if (button == 'yes') {
				store1.sync({
					params : {
						V_TYPE : 'SYNC',
