...
Ext.define('B_ITEM_SALE_HSPF.view.MyGrid', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.myGrid',

    requires: [
        'B_ITEM_SALE_HSPF.view.MyGridViewModel',
        'B_ITEM_SALE_HSPF.view.MyGridViewController',
        'Ext.view.Table',
                ...
                listeners: {
                    afterrender: function(c) {
    					c.getEl().on('dblclick', function() {
    						...
    						Ext.getCmp('W_TYPE').setValue('B_ITEM_SALE_HSPF');
                ...
                listeners: {
                    afterrender: function(c) {
                    	c.getEl().on('dblclick', function() {
    						...
    						Ext.getCmp('fieldType').setValue('B_ITEM_SALE_HSPF');
        ...
        },
        {
            ...
            listeners: {
            	edit: function(editor, context, eOpts) {
          	  	...
          	  	//기존 등록된 아이템은 거래처품목코드, 거래처품목명, 단가만 변경할 수 있다.
