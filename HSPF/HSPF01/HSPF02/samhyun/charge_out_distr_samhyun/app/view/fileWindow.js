...
Ext.define('M_CHARGE_OUT_DISTR_SAMHYUN.view.fileWindow', {
    extend: 'Ext.window.Window',
    alias: 'widget.filewindow',

    requires: [
        'M_CHARGE_OUT_DISTR_SAMHYUN.view.fileWindowViewModel',
        'Ext.form.Panel',
        'Ext.form.field.File'
    ],
    ...
    onFilefieldChange: function(filefield, value, eOpts) {
        ...
        if(form.isValid()){
            var params = 'V_TYPE=I';
            form.submit({
                url: 'sql/charge_out_file.jsp?' + params,
                ...
                failure: function(fp, o) {
                    ...
                    for(var i = 0 ; i < jResult.resultList.length ; i ++){
                        console.log(jResult.resultList[i].FILE_NM + ' , ' + jResult.resultList[i].FILE_IN_SYSTEM_NM);
                        var rec = Ext.create('M_CHARGE_OUT_DISTR_SAMHYUN.model.MyModel', {
                            V_TYPE : 'I',
                            FILE_NM: jResult.resultList[i].FILE_NM,
                            FILE_IN_SYSTEM_NM: jResult.resultList[i].FILE_IN_SYSTEM_NM,
