...
Ext.define('S_BL_DIST_WGT_TOT_HSPF.controller.TbButtonController', {
    ...
    saveBtnClick: function(button, e, eOpts) {
    	...
    	store.sync({
			...
			callback : function(records, operation, success) {
				var tbController = S_BL_DIST_WGT_TOT_HSPF.app.getController("TbButtonController");
    ...
    clrBtnClick: function(button, e, eOpts) {
    	...
    	Ext.getCmp('V_TOTAL_GROSS_WGT').setValue('');
    },
