    	...
    	Ext.Ajax.request({
			...
			success : function(response) {
				...
				if(STATUS == 'X') {
					...
					if(FLAG == 'C') { //출하취소요청서
						Ext.getCmp('main').setHtml('<iframe name="xxx" border =0 src="http://123.142.124.170:8080/aireport/on_server/STEEL/S_DN_PAPER_N_STEEL.jsp?PRINT_NO='+PRINT_NO+'" width="100%" height="100%"></iframe>');
					} else {
						Ext.getCmp('main').setHtml('<iframe name="xxx" border =0 src="http://123.142.124.170:8080/aireport/on_server/STEEL/S_DN_PAPER_Y_STEEL.jsp?PRINT_NO='+PRINT_NO+'" width="100%" height="100%"></iframe>');
					}
