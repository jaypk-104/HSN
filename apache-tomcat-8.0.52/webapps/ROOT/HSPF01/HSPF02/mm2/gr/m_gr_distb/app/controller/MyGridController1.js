...
Ext.define('M_GR_DISTB.controller.MyGridController1', {
	...
	chargeUpdateBtnClick : function(button, e, eOpts) {
		...
		if(gridRecord1.length == 1) {
			...
			if(flag == 'T') {
				var popup = Ext.create("M_GR_DISTB.view.MyWindow1");
...
//		    	console.log(jsonResult);
	...
	w_chargeSyncBtnClick : function(button, e, eOpts) {
		
		var chargeStore = Ext.getStore('ChargeStore');
		chargeStore.each(function(rec, idx) {
			let syncAmt = rec.get('CHARGE_AMT') - rec.get('TOT_DISB_AMT');
			rec.set('DISTB_AMT', syncAmt);
		});
