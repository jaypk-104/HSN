...
Ext.define('A_AR_RECEIPT2.controller.MyGridController', {
...
//			store5.removeAll();
			...
			for(var i=0; i<selectedRecords.length; i++){
				...
				var record = Ext.create('A_AR_RECEIPT2.model.MyModel', {
					V_TYPE: 'I',
					...
					LOC_AMT: selectedRecord.get('IN_AMT'),
...
//			store5.removeAll();
			...
			for(var i=0; i<selectedRecords.length; i++){
				...
				var record = Ext.create('A_AR_RECEIPT2.model.MyModel', {
					...
					BP_CD: selectedRecord.get('BP_CD'),
					BP_NM: selectedRecord.get('BP_NM'),
					BANK_DT: selectedRecord.get('ISSUE_DT'),
					BANK_CD: selectedRecord.get('BANK_CD'),
					BANK_NM: selectedRecord.get('BANK_NM'),
					LOC_AMT: selectedRecord.get('NOTE_AMT'),
					BAL_AMT: selectedRecord.get('NOTE_AMT'),
					REMAIN_AMT: selectedRecord.get('NOTE_AMT'),
	    		});
				...
				if(i === 0){
					...
					Ext.getCmp('V_CLS_DT').setValue(selectedRecord.get('ISSUE_DT'));
					Ext.getCmp('V_BP_NM').setValue(selectedRecord.get('BP_NM'));
					Ext.getCmp('V_BP_CD').setValue(selectedRecord.get('BP_CD'));
					Ext.getCmp('V_DEPT_CD2').setValue(selectedRecord.get('DEPT_CD'));
					Ext.getCmp('V_CUR').setValue(selectedRecord.get('CUR'));
