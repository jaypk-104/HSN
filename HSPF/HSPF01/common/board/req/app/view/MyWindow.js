...
Ext.define('HSPF_REQ_BOARD.view.MyWindow', {
    extend: 'Ext.window.Window',
    alias: 'widget.mywindow',

    requires: [
        'HSPF_REQ_BOARD.view.MyWindowViewModel',
        'Ext.form.Panel',
        'Ext.form.field.File'
    ],
    ...
    onFilefieldChange: function(filefield, value, eOpts) {
        ...
        if(form.isValid()){
            var params = 'V_TYPE=I';
            form.submit({
                url: 'sql/req_board_file.jsp?' + params,
                ...
                success : function(fp, res) {
                    ...
                    for(var i = 0 ; i < jResult.resultList.length ; i ++){
                        ...
                        var rec = Ext.create('HSPF_REQ_BOARD.model.MyModel', {
                            V_TYPE : 'I',
