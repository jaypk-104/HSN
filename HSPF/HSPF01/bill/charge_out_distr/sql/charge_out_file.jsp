...
// 			String savePath = "/data/apache/webapps/ROOT/HSPF01_FILE/";
			String savePath = "/data/M_BP_CHARGE/";
			...
			cs = conn.prepareCall("call USP_M_BP_CHARGE_FILE_MGM(?,?,?,?,?,?)");
			cs.setString(1, V_TYPE); //
			cs.setString(2, V_M_CHARGE_NO); //문서고유번호
			cs.setString(3, ""); //
			cs.setString(4, ""); //
			...
			if (jsonData.lastIndexOf("},{") > 0) { //배열일경우
				...
				for (int i = 0; i < jsonAr.size(); i++) {
					...
					String FILE_IN_SYSTEM_NM = hashMap.get("FILE_IN_SYSTEM_NM") == null ? "" : hashMap.get("FILE_IN_SYSTEM_NM").toString();
					...
					cs.setString(4, FILE_IN_SYSTEM_NM); //
					cs.setString(5, V_USR_ID); //
					cs.registerOutParameter(6, com.tmax.tibero.TbTypes.CURSOR);
				...
				String FILE_IN_SYSTEM_NM = jsondata.get("FILE_IN_SYSTEM_NM") == null ? "" : jsondata.get("FILE_IN_SYSTEM_NM").toString();
