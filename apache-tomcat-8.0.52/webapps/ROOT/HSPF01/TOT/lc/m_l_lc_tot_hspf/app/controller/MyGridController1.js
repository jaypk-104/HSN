...
Ext.define('M_L_LC_TOT_HSPF.controller.MyGridController1', {
	    				...
	    				if(res.match('V')) {
	    					...
	    					store1.sync({ 
	    						...
	    						callback : function(records, operation, success) {
						    		var tbController = M_L_LC_TOT_HSPF.app.getController("TbButtonController");
