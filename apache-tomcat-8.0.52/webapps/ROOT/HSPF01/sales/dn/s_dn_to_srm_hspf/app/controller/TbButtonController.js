...
Ext.define('S_DN_TO_SRM_HSPF.controller.TbButtonController', {
    ...
    chkChange: function(field, newValue, oldValue, eOpts) {
    	...
    	var tbController = S_DN_TO_SRM_HSPF.app.getController("TbButtonController");
    	...
    	if( Ext.getCmp('V_DN_USR').getValue() == null || Ext.getCmp('V_DN_USR').getValue() == ''){
        	...
        	store.load({
        		params: {
                    ...
                    V_CUST_ORDER_NO: Ext.getCmp('V_CUST_PO_NO').getValue(),
