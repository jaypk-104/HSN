...
Ext.define('A_AR_RECEIPT.controller.FileGridController', {
	...
	fileGridDblClick : function(tableview, td, cellIndex, record, tr, rowIndex, e, eOpts) {
		...
		var myWin = new Ext.Window({
			title : '파일다운로드',
			html : '<iframe name="xxx" border =0 src="sql/A_ELEC_FILE_TO_GW.jsp?V_TYPE=D&V_FILE_NM=' + V_FILE_NM + '&V_FILE_IN_SYSTEM_NM=' + V_FILE_IN_SYSTEM_NM + '" width="1%" height="1%"></iframe>',
			width : 500,
			height : 500
		});
	...
	fileDownBtnClick : function() {
		...
		for (var i = 0; i < gridRecord.length; i++) {
			...
			V_FILE_NM = V_FILE_NM.replaceAll('#', '%23');
			V_FILE_NM = V_FILE_NM.replaceAll('+', '%2B');
			V_FILE_NM = V_FILE_NM.replaceAll('&', '%26'); // &기호 인코딩 안되서.. 일단
															// 추가해줌
			var myWin = new Ext.Window({
				title : '파일다운로드',
				html : '<iframe name="xxx" border =0 src="sql/A_ELEC_FILE_TO_GW.jsp?V_TYPE=D&V_FILE_NM=' + V_FILE_NM + '&V_FILE_IN_SYSTEM_NM=' + V_FILE_IN_SYSTEM_NM + '" width="1%" height="1%"></iframe>',
