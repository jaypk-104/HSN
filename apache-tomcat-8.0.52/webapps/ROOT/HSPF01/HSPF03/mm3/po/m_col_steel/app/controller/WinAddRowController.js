...
Ext.define('M_COL_STEEL.controller.WinAddRowController', {
    ...
    addRowBtnClick: function(button, e, eOpts) {
    	...
    	for(var i=0; i<rowCount; i++) {
    		...
    		var rec = Ext.create('M_COL_STEEL.model.MyModel', {
    			ITEM_NM: record[0].get('ITEM_NM'),
    			DOC_AMT: record[0].get('DOC_AMT'),
    			LOC_AMT: record[0].get('LOC_AMT'),
    			PO_NO: record[0].get('PO_NO'),
    			PO_SEQ: record[0].get('PO_SEQ'),
    		});
