...
Ext.define('S_CONT_HSPF.controller.MyGridController1', {
    ...
    gridAddBtn1Click: function(button, e, eOpts) {
        var popup = Ext.create("S_CONT_HSPF.view.WinAddRow3");
        popup.show();
        Ext.getCmp('rowCount3').setValue(1);
    },
    ...
    gridBtn1Click: function(button, e, eOpts) {
            alert('미등록');
    },

    gridBtn2Click: function(button, e, eOpts) {
        alert('등록');
    }
