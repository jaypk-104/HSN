...
<%
	session.setAttribute("PRINT_NO", request.getParameter("PRINT_NO"));
	session.setAttribute("MR", request.getParameter("MR"));
	session.setAttribute("FLAG", request.getParameter("FLAG"));
	session.setAttribute("APP", request.getParameter("APP"));
%>
