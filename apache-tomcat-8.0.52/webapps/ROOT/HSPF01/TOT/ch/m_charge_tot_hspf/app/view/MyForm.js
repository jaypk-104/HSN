...
Ext.define('M_CHARGE_TOT_HSPF.view.MyForm', {
                                ...
                                afterrender: function(c) {
                                	c.getEl().on('dblclick', function() {
                                		...
                                		if(Ext.getCmp('V_PR_STEP').getValue() == 'VC') {
                                			var popup = Ext.create("M_CHARGE_TOT_HSPF.view.WinCcPop");
...
//                                			popStore.removeAll();
                                			...
                                			M_CHARGE_TOT_HSPF.app.getController("MyPopController").popSelBtnClick();
                                			
                                		} else if (Ext.getCmp('V_PR_STEP').getValue() == 'VB') {
                                			var popup = Ext.create("M_CHARGE_TOT_HSPF.view.WinBlPop");
                                			popup.setSize(width, height);
                                			popup.center();
                                			popup.show();
...
//                                			popStore.removeAll();
                                			...
                                			var popup = Ext.create("M_CHARGE_TOT_HSPF.view.WinLcPop");
                                			popup.setSize(width, height);
                                			popup.center();
                                			popup.show();
