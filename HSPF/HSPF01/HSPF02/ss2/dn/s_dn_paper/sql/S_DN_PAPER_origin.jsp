...
// 			System.out.println(jsonData);
			...
			if (jsonData.lastIndexOf("},{") > 0) { //배열일경우
				...
				for (int i = 0; i < jsonAr.size(); i++) {
					...
					if (status.equals("OK")) {
						...
						if (V_TYPE.equals("MAIL_CANCEL")) {
							subject = "[" + today + "]" + V_S_BP_NM + " 출하취소요청서"; //메일 제목 입력해주세요. 
						} else {
							subject = "[" + today + "]" + V_S_BP_NM + " 출하요청서"; //메일 제목 입력해주세요.
						}
						...
						if (V_TYPE.equals("MAIL_CANCEL")) {
							...
							body += "<DIV>&nbsp;</DIV>";
							body += "<STRONG><SPAN style=\"FONT-SIZE: 20pt\"><A href=\"http://123.142.124.160:8080/HSPF01/HSPF02/ss2/dn/s_dn_paper_view/S_DN_PAPER_VIEW.jsp?PRINT_NO=" + V_PRINT_NO.replaceAll("-", "") + "&MR=" + V_MR + "\">출하취소요청서보기</A>&nbsp;<BR></SPAN></STRONG><BR><BR><BR>※바로가기를 통하여 출하요청서를 확인 할 수 없으신분은 화승네트웍스 그룹웨어에 로그인<BR>하신 후 확인 할 수 있습니다.";
						} else {
							...
							body += "<DIV>&nbsp;</DIV>";
							body += "<STRONG><SPAN style=\"FONT-SIZE: 20pt\"><A href=\"http://123.142.124.160:8080/HSPF01/HSPF02/ss2/dn/s_dn_paper_view/S_DN_PAPER_VIEW.jsp?PRINT_NO=" + V_PRINT_NO.replaceAll("-", "") + "&MR=" + V_MR + "\">출하요청서보기</A>&nbsp;<BR></SPAN></STRONG><BR><BR><BR>※바로가기를 통하여 출하요청서를 확인 할 수 없으신분은 화승네트웍스 그룹웨어에 로그인<BR>하신 후 확인 할 수 있습니다.";
						}
				...
				System.out.println("V_PRINT_NO" + V_PRINT_NO);
				...
				if (status.equals("OK")) {
					...
					if (V_TYPE.equals("MAIL_CANCEL")) {
						...
						body += "<DIV><SPAN style=\"FONT-SIZE: 10pt\"><SPAN 9pt>※출하취소요청서 승인은 출하취소요청서보기에서 할수있습니다.</SPAN></SPAN></DIV>";
						body += "<DIV>&nbsp;</DIV>";
						body += "<STRONG><SPAN style=\"FONT-SIZE: 20pt\"><A href=\"http://123.142.124.160:8080/HSPF01/HSPF02/ss2/dn/s_dn_paper_view/S_DN_PAPER_VIEW.jsp?PRINT_NO=" + V_PRINT_NO.replaceAll("-", "") + "&MR=" + V_MR + "&FLAG=C\">출하취소요청서보기</A>&nbsp;<BR></SPAN></STRONG><BR><BR><BR>※바로가기를 통하여 출하요청서를 확인 할 수 없으신분은 화승네트웍스 그룹웨어에 로그인<BR>하신 후 확인 할 수 있습니다.";
					} else {
						body += "<SPAN style=\"FONT-SIZE: 14pt\">출하요청서 승인 부탁드립니다.</SPAN>";
						body += "<DIV><SPAN style=\"FONT-SIZE: 10pt\"><SPAN 9pt>※출하요청서 승인은 출하요청서보기에서 할수있습니다.</SPAN></SPAN></DIV>";
						body += "<DIV>&nbsp;</DIV>";
						body += "<STRONG><SPAN style=\"FONT-SIZE: 20pt\"><A href=\"http://123.142.124.160:8080/HSPF01/HSPF02/ss2/dn/s_dn_paper_view/S_DN_PAPER_VIEW.jsp?PRINT_NO=" + V_PRINT_NO.replaceAll("-", "") + "&MR=" + V_MR + "&FLAG=Y\">출하요청서보기</A>&nbsp;<BR></SPAN></STRONG><BR><BR><BR>※바로가기를 통하여 출하요청서를 확인 할 수 없으신분은 화승네트웍스 그룹웨어에 로그인<BR>하신 후 확인 할 수 있습니다.";
					}
			...
			if (jsonData.lastIndexOf("},{") > 0) { //배열일경우
				...
				System.out.println("V_V_DN_REQ_DT" + V_V_DN_REQ_DT);
