...
Ext.define('M_GR_TOT_HSPF2.view.MyViewport', {
    extend: 'Ext.container.Viewport',
    alias: 'widget.myviewport',

    requires: [
        'M_GR_TOT_HSPF2.view.MyViewportViewModel',
        'M_GR_TOT_HSPF2.view.MyViewportViewController',
        'Ext.button.Button',
        'Ext.form.Panel',
        'Ext.form.FieldSet',
                                ...
                                },
                                {
                                    ...
                                    listeners: {
                                    	edit: function(editor, context, eOpts) {
                                    		...
                                    		var PO_QTY = Number(context.record.data.PO_QTY); 
