					...
					listeners : {
						afterrender : function(c) {
							c.getEl().on('dblclick', function() {
								...
								M_COL_STEEL.app.getController("ColPopController").w_colSelBtnClick();
					...
					listeners : {
						afterrender : function(c) {
							c.getEl().on('dblclick', function() {
								...
								M_COL_STEEL.app.getController("PoPopController").w_poSelBtnClick();
								//                                              
								//                                        		store.removeAll();
							});
						}
						...
						listeners : {
            				afterrender : function(c) {
            					this.mon(this.getEl(), 'dblclick', function() {
            						var popup = Ext.create("M_COL_STEEL.view.MyWindow2");
            						popup.center();
            						popup.show();
