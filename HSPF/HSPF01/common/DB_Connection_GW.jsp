...
<%
	...
	String url = "jdbc:sqlserver://123.142.124.148:1433";
	String user = "sa";
	String password = "ghktmd10$*";

	String connectionString = "jdbc:sqlserver://123.142.124.148:1433;" + "databaseName=groupware_new;user=sa;password=ghktmd10$*";
