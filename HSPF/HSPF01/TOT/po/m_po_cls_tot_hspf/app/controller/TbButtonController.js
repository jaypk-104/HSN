...
Ext.define('M_PO_CLS_TOT_HSPF.controller.TbButtonController', {
    ...
    selBtnClick: function(button, e, eOpts) {
    	...
    	store.load({
    		params: {
    			...
    			V_CLS_YN: Ext.getCmp('V_CLS_YN').getValue(),
    ...
    clrBtnClick: function(button, e, eOpts) {
    	...
    	Ext.getCmp('V_CLS_YN').setValue('N');
    	Ext.getCmp('V_PO_TYPE').setValue('T');
