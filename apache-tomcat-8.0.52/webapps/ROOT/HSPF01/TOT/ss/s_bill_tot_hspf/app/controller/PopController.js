...
Ext.define('S_BILL_TOT_HSPF.controller.PopController', {
	...
	w_popGridDblClick : function(tableview, td, cellIndex, record, tr, rowIndex, e, eOpts) {
		...
		Ext.getCmp('V_TAX_BILL_YN').setValue(record.get('TAX_BILL_YN'));
		Ext.getCmp('V_TAX_BILL_SEND_YN').setValue(record.get('TAX_BILL_SEND_YN'));
		Ext.getCmp('V_CR_TYPE').setValue(record.get('CR_TYPE'));
