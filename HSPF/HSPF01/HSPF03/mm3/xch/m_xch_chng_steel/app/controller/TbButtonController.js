...
Ext.define('M_XCH_CHNG_STEEL.controller.TbButtonController', {
    ...
    selBtnClick: function(button, e, eOpts) {
    	...
    	store.load({
    		params: {
    			...
    			V_M_BP_CD : Ext.getCmp('V_BP_CD').getValue(),
    ...
    clrBtnClick: function(button, e, eOpts) {
		...
		Ext.getCmp('V_LD_DT_TO').setValue(nows);
		nows.setDate(1);
		Ext.getCmp('V_LD_DT_FR').setValue(nows);
    },
