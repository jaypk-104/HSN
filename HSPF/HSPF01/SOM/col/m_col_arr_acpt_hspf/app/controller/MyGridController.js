...
Ext.define('M_COL_ARR_ACPT_HSPF.controller.MyGridController', {
	...
	gridAddBtnClick : function(button, e, eOpts) {
		var popup = Ext.create("M_COL_ARR_ACPT_HSPF.view.WinAddRow");
		popup.show();
			...
			if (button == 'yes') {
				store.sync({
					...
					callback : function(records, operation, success) {
						var tbController = M_COL_ARR_ACPT_HSPF.app.getController("TbButtonController");
