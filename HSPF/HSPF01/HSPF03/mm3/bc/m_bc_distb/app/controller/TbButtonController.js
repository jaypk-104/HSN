...
Ext.define('M_BC_DISTB.controller.TbButtonController', {
    ...
    selBtnClick: function(button, e, eOpts) {
    	...
    	store.load({
    		params: {
    			...
    			V_LOADING_DT_FR: Ext.getCmp('V_LOADING_DT_FR').getValue(),
    			V_LOADING_DT_TO: Ext.getCmp('V_LOADING_DT_TO').getValue(),
    			V_M_BP_NM: Ext.getCmp('V_M_BP_NM').getValue(),
    			V_BL_DOC_NO: Ext.getCmp('V_BL_DOC_NO').getValue(),
    			V_CC_YN: Ext.getCmp('V_CC_YN').getValue(),
    			V_INTEREST: Ext.getCmp('V_INTEREST').getValue(),
    		},
