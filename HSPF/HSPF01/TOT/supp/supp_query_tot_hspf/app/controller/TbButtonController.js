...
Ext.define('SUPP_QUERY_TOT_HSPF.controller.TbButtonController', {
    ...
    selBtnClick: function(button, e, eOpts) {
        ...
        store.load({
            params: {
                ...
                V_DLV_REQ_DT_FR : Ext.getCmp('V_DLV_REQ_DT_FROM').getValue(),
                V_DLV_REQ_DT_TO : Ext.getCmp('V_DLV_REQ_DT_TO').getValue(),
                V_DLV_DT_CHECK : Ext.getCmp('V_DLV_DT_CHECK').getValue(),
                
                V_PO_NO : Ext.getCmp('V_PO_NO').getValue(),
                V_ASN_NO : Ext.getCmp('V_ASN_NO').getValue(),
                
                V_PO_DT_FR : Ext.getCmp('V_PO_DT_FROM').getValue(),
