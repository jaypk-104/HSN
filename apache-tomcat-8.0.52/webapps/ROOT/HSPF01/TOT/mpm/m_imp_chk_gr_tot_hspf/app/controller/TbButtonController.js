...
Ext.define('M_IMP_CHK_GR_TOT_HSPF.controller.TbButtonController', {
...
//    		}
    		...
    		Ext.Msg.confirm('확인', '계열사: ' + BP_NM + '<br>입고 업로드하시겠습니까?', function(button) {
    			if (button == 'yes') {
    				store.sync({
    	    			params: {
    	    				V_TYPE : 'SYNC',
    	    			...
    	    			callback: function(records, operation, success) {
    	    				var tbController = M_IMP_CHK_GR_TOT_HSPF.app.getController("TbButtonController");
