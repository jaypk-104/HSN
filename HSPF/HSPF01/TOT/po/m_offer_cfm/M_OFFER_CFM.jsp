...
.bg-green .x-change-cell1 {
    background-color: #D8F6CE;
    font-weight: bold;
}
.bg-green .x-change-cell2 {
    background-color: #D8F6CE;
    font-weight: bold;
}
.bg-green .x-change-cell3 {
    background-color: #D8F6CE;
    font-weight: bold;
}
.bg-green .x-change-cell4 {
    background-color: #D8F6CE;
    font-weight: bold;
}
.bg-green .x-change-cell5 {
    background-color: #D8F6CE;
    font-weight: bold;
}

.bg-red .x-change-cell1 {
    background-color: #f9dede;
    font-weight: bold;
}
.bg-red .x-change-cell2 {
    background-color: #f9dede;
    font-weight: bold;
}
.bg-red .x-change-cell3 {
    background-color: #f9dede;
    font-weight: bold;
}
.bg-red .x-change-cell4 {
    background-color: #f9dede;
    font-weight: bold;
}
.bg-red .x-change-cell5 {
    background-color: #f9dede;
    font-weight: bold;
}
</style>
