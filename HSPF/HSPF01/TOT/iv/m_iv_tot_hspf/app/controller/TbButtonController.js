...
Ext.define('M_IV_TOT_HSPF.controller.TbButtonController', {
    ...
    selBtnClick: function(button, e, eOpts) {
    	...
    	store.load({
    		params: {
    			...
    			V_SWM_YN: Ext.getCmp('V_SWM_YN').getValue(),
    		},
    			...
    			if(Ext.getCmp('V_IV_NO').getValue() != '') {
    		    	...
    		    	Ext.Ajax.request({
    					...
    					success: function(response) {
    						...
    						Ext.getCmp('V_INSRT_USR_ID').setValue(res.INSRT_USR_ID);
...
//			msg = '가격조건을 선택하세요.';
    ...
    clrBtnClick: function(button, e, eOpts) {
		...
		Ext.getCmp('V_INSRT_USR_ID').setValue('');
