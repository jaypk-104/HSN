...
// 		System.out.println("V_FLAG" + V_FLAG);
		...
		if (V_TYPE.equals("LOAD")) {
			...
			cs2 = conn.prepareCall("call USP_PRINT_CNT(?,?,?)");
...
// 			System.out.println("취소승인");
			...
			if (STATUS.equals("Y")) {
				...
				if(V_FLAG.equals("C")) {
					...
					body += "<STRONG><SPAN style=\"FONT-SIZE: 20pt\"><A href=\"http://123.142.124.160:8080/HSPF01/HSPF02/ss2/dn/s_dn_paper_view/S_DN_PAPER_VIEW.jsp?PRINT_NO=" + V_PRINT_NO.replaceAll("-", "") + "\">출하요청서보기</A>&nbsp;<BR></SPAN></STRONG><BR><BR><BR>";
					body += "<DIV>&nbsp;</DIV>";
				} else {
