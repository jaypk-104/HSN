...
Ext.define('I_INVTORY_ENERGY_TOT_HSPF.controller.MyGridController', {
	...
	gridAddBtnClick : function(button, e, eOpts) {
		var popup = Ext.create("I_INVTORY_ENERGY_TOT_HSPF.view.WinAddRow");
		popup.show();
	...
	gridExecBtnClick : function(button, e, eOpts) {
		...
		Ext.Ajax.request({
			url : 'sql/I_INVTORY_ENERGY_TOT_HSPF.jsp',
			method : 'post',
			params : {
				V_TYPE : 'CHK_GL',
						...
						if (button == 'yes') {
							...
							Ext.Ajax.request({
								...
								success : function(response) {
									...
									var tbController = I_INVTORY_ENERGY_TOT_HSPF.app.getController("TbButtonController");
