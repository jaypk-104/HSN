...
Ext.define('M_DUTY_CHARGE_OUT_DISTR.controller.TbButtonController', {
        ...
        Ext.MessageBox.confirm('확인', '저장하지 않은 내용은 사라집니다.<br>새문서로 이동 하시겠습니까?', function(btn) {
            if(btn == 'yes') {
                ...
                var dynamicTab={
                    ...
                    title : '관세부대경비정산(황보)',
                    //autoScroll: true,
                    html : '<iframe name="xxx" border =0 src="/HSPF01/bill/duty_charge_out_distr/DUTY_CHARGE_OUT_DISTR.jsp" width="100%" height="100%"></iframe>',
                    closable : true
                };
                //activeTab.hide();
