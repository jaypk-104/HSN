...
<%
	...
	try {
		...
		String V_BANK_NM = request.getParameter("V_BANK_NM") == null ? "" : request.getParameter("V_BANK_NM").toUpperCase();
		String sql = "";

		cs = conn.prepareCall("call USP_B_POPUP_HSPF(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
		cs.setString(1, V_TYPE);//V_TYPE
		cs.setString(2, "");//V_COMP_ID
		cs.setString(3, V_BANK_CD);//V_BP_CD
		cs.setString(4, V_BANK_NM);//V_BP_NM
