...
<script type="text/javascript" src="<c:url value='/ext6.5/build/packages/charts/classic/charts.js'/>"></script>
<link href="<c:url value='/'/>ext6.5/build/packages/charts/classic/triton/resources/charts-all.css" rel="stylesheet" type="text/css">
