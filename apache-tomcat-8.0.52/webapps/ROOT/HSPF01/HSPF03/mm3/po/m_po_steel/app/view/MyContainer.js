...
Ext.define('M_PO_STEEL.view.MyContainer', {
    extend: 'Ext.container.Container',
    alias: 'widget.mycontainer',
    
    requires: [
        'M_PO_STEEL.view.MyContainerViewModel',
        'M_PO_STEEL.view.MyContainerViewController',
        'Ext.form.FieldSet',
                                    ...
                                    listeners: {
                                        afterrender: function(c) {
                                        	c.getEl().on('dblclick', function() {
                                        		var popup = Ext.create("M_PO_STEEL.view.WinPoPop");
                                                
                                                popup.setSize(Ext.getBody().getViewSize());
                                                popup.show();
                                                
                                                var store = Ext.getStore('PopStore');
                                                M_PO_STEEL.app.getController("PoPopController").w_poSelBtnClick();
//                                        		store.removeAll();
                                            });
                                        }
                                    },
                                ...
                                },
                                {
                                    ...
                                    listeners: {
                                        afterrender: function(c) {
                                        	c.getEl().on('dblclick', function() {
                                        		var popup = Ext.create("M_PO_STEEL.view.WinConPop");
                                                
                                                popup.setSize(Ext.getBody().getViewSize());
                                                popup.show();
                                                
                                                M_PO_STEEL.app.getController("ConPopController").w_conSelBtnClick();
//                                        		
                                    ...
                                    listeners: {
                                        afterrender: function(c) {
                                        	c.getEl().on('dblclick', function() {
                                    			...
                                    			Ext.getCmp('fieldType').setValue('M_PO_STEEL');
...
//                        	disabled: true,
                    ...
                    columns: [
                        ...
                        },
                        {
                            ...
                            dataIndex: 'ITEM_CD',
                            text: '<span style=\'color:red\'>*</span>품목그룹코드',
                            width: 100,
                            editor: {
                                xtype: 'textfield',
                                allowBlank: false,
                                ...
                                listeners: {
                                    afterrender: function(c) {
                                    	c.getEl().on('dblclick', function() {
                                    		...
                                    		Ext.getCmp('W_TYPE').setValue('PO_STEEL');
