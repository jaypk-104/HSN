...
Ext.define('M_GR_TO_DN_DISTR.view.MyWindow3', {
    extend: 'Ext.window.Window',
    alias: 'widget.mywindow3',

    requires: [
        'M_GR_TO_DN_DISTR.view.MyWindow3ViewModel',
        'Ext.form.field.Date',
        'Ext.grid.Panel',
                            	...
                            	listeners : {
                    				afterrender : function(c) {
                    					this.mon(this.getEl(), 'dblclick', function() {
                    						if(!!!Ext.getCmp('V_NEW_MAST_DB_NO').getValue()){
                    							Ext.Msg.alert('확인', '담보번호가 없습니다.');
                    						} else {
                    							var popup = Ext.create("M_GR_TO_DN_DISTR.view.WinArPop");
                        						popup.center();
                        						popup.show();

                        						var store = Ext.getStore('ArPopStore');
                        						store.removeAll();

                        						Ext.getCmp('W_DT_FR').setValue(Ext.getCmp('V_NEW_COL_DT').getValue());
                    						}
                    					});
                    				}
                    			}
