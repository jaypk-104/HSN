...
Ext.define('CONTAINER_TRACKING_SELECT.controller.MyGridController', {
    ...
    onGridpanelCellDblClick: function(tableview, td, cellIndex, record, tr, rowIndex, e, eOpts) {
        var window = Ext.create('CONTAINER_TRACKING_SELECT.view.MyWindow');
        var windowStore = Ext.getCmp('windowGrid').getStore();
        windowStore.load({
            params:{
                V_TYPE : 'WS',
                V_CONTAINER_NO : record.data['CONTAINER_NO'],
                V_BL_DOC_NO : record.data['BL_DOC_NO'],
            }
        });
        window.show();
    }
