...
Ext.define('B_PR_USR_DISTR.controller.TbButtonController', {
    ...
    selBtnClick: function(button, e, eOpts) {
    	...
    	store.load({
    		params: {
    			...
    			V_USR_ID2: Ext.getCmp('V_USR_ID2').getValue(),
    		},
    ...
    saveBtnClick: function(button, e, eOpts) {
    	...
    	for(var i=0; i<gridRecord.length; i++) {
    		if(gridRecord[i].data['V_TYPE'] == 'V') {
    			console.log(gridRecord[i].phantom);
...
//				console.log(res);
				...
				if(res.match('Exception')) {
					...
					var tbController = B_PR_USR_DISTR.app.getController("TbButtonController");
