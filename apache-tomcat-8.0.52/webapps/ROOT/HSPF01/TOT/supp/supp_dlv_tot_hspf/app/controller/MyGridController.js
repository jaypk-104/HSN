...
Ext.define('SUPP_DLV_TOT_HSPF.controller.MyGridController', {
	...
	gridSaveBtnClick : function(button, e, eOpts) {
		...
		store.each(function(record, idx) {
			if((record.get('DLVY_AVL_DT') != '' && record.get('DLVY_AVL_DT') != null  && record.get('DLVY_AVL_DT') != undefined) && record.get('DLVY_AVL_QTY') >= 1) {
				Ext.getCmp('myGrid').getSelectionModel().select(record, true);
			}
		});
