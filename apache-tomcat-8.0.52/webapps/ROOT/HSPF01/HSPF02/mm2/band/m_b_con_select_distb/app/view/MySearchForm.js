...
Ext.define('M_B_CON_SELECT_DISTB.view.MySearchForm', {
    extend: 'Ext.form.Panel',
    alias: 'widget.mysearchform',

    requires: [
        'M_B_CON_SELECT_DISTB.view.MySearchFormViewModel',
        'Ext.form.FieldSet',
...
//                                		var popup = Ext.create("M_B_CON_SELECT_DISTB.view.WinBlPop");
...
//                            			popup.show();
//                            			
//                            			Ext.getCmp('fieldType').setValue('M_B_CON_SELECT_DISTB2');
