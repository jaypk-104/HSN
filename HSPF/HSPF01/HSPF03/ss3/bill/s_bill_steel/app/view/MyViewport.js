...
Ext.define('S_BILL_STEEL.view.MyViewport', {
    extend: 'Ext.container.Viewport',
    alias: 'widget.myviewport',

    requires: [
        'S_BILL_STEEL.view.MyViewportViewModel',
        'S_BILL_STEEL.view.MyViewportViewController',
        'S_BILL_STEEL.view.TbButton',
        'S_BILL_STEEL.view.MyForm',
        'S_BILL_STEEL.view.MyGrid',
        'S_BILL_STEEL.view.MyGrid1',
        'Ext.form.Panel',
        'Ext.grid.Panel',
                                            ...
                                            listeners: {
                                                afterrender: function(c) {
                                                	c.getEl().on('dblclick', function() {
                                                		var popup = Ext.create("S_BILL_STEEL.view.MyWindow1");
