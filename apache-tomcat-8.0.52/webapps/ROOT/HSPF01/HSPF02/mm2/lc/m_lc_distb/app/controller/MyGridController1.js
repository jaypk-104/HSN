...
Ext.define('M_LC_DISTB.controller.MyGridController1', {
	    				...
	    				if(res.match('V')) {
	    					...
	    					store1.sync({ 
	    						...
	    						callback : function(records, operation, success) {
						    		var tbController = M_LC_DISTB.app.getController("TbButtonController");
...
//	    					});
	...
	lcCancelBtnClick : function(button, e, eOpts) {
		Ext.Msg.confirm('확인', '취소처리겠습니까?', function(button) {
			if (button == 'yes') {
				Ext.Ajax.request({
					url : 'sql/M_LC_DISTB_H.jsp',
					method : 'post',
...
//					console.log(response);
					...
					if (response.responseText == 'SUCCESS'){
						...
						msg = '에러 발생<br>' + response.responseText;
					}
					Ext.Msg.alert('확인', msg);
				});
			}
