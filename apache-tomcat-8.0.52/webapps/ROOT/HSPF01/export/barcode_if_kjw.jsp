...
// 			System.out.println(V_ITEM_CD);
		...
		//입고예정정보
			...
			System.out.println("------SWM 입고 바코드 확인-----");
			...
			cs = conn137.prepareCall("call USP_SUPP_TO_GR_INSERT_TEST20201124(?,?,?,?,?)");
// 			cs = conn.prepareCall("call USP_SUPP_TO_GR_INSERT_TEST20201124(?,?,?,?,?)");
			cs.setString(1, V_TYPE);
			cs.setString(2, V_BAR_NO);
...
// 			cs = conn.prepareCall("call USP_SUPP_TO_GR_INSERT_TEST20201124(?,?,?,?,?)");
			...
			System.out.println("------SWM 입고 바코드 처리중-----");
...
// 			cs = conn.prepareCall("call USP_DN_HSNA_INSERT(?,?,?,?,?,?)");
			cs = conn137.prepareCall("call USP_DN_HSNA_INSERT_TEST20201125(?,?,?,?,?,?)");
			cs.setString(1, V_TYPE);
			cs.setString(2, V_BAR_NO);
			cs.setString(3, V_USR_ID);//V_USR
